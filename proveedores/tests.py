...
class ProveedorFormTest(TestCase):
    ...
    def test_form_placeholders(self):
        ...
        form = ProveedorForm()
        self.assertEqual(form.fields['nombre'].widget.attrs['placeholder'], 'Nombre del proveedor')
        self.assertEqual(form.fields['telefono'].widget.attrs['placeholder'], '+593-99-999-9999')
        self.assertEqual(form.fields['correo'].widget.attrs['placeholder'], 'correo@proveedor.com')
